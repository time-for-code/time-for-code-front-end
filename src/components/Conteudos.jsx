            ...
            <div className="container">
                ...
                <div className="content-grid">
                    <div className="content-box">
                        ...
                        <Link reloadDocument="true" to={'/exercise/$id'} params={{ id: 1 }} className="btn">Começar Jogo</Link>
                    </div>
                    <div className="content-box">
                        <h3>Robô no Labirinto</h3>
                        <p>Ajude o robô a sair do labirinto, organizando as instruções corretas.</p>
                        <Link reloadDocument="true" to={'/exercise/$id'} params={{ id: 2 }} className="btn">Começar Jogo</Link>
                    </div>
                    <div className="content-box">
                        <h3>Caça ao Tesouro</h3>
                        <p>Encontre o tesouro seguindo padrões de pistas escondidas.</p>
                        <Link reloadDocument="true" to={'/exercise/$id'} params={{ id: 3 }} className="btn">Começar Jogo</Link>
                    </div>
                    <div className="content-box">
                        <h3>Quebra-Cabeça Gigante</h3>
                        <p>Encontre o tesouro seguindo padrões de pistas escondidas.</p>
                        <Link reloadDocument="true" to={'/exercise/$id'} params={{ id: 4 }} className="btn">Começar Jogo</Link>
                    </div>
                </div>
            </div>
        </section>
